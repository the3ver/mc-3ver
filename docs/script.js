...
const TRANSLATIONS = {
  de: {
    ...
    "install.step2.desc": "Lade die fertige <code class=\"code-badge\">mc-3ver-0.2.0.jar</code> aus den GitHub Releases herunter.",
  ...
  en: {
    ...
    "install.step2.desc": "Download the release <code class=\"code-badge\">mc-3ver-0.2.0.jar</code> from GitHub Releases or via Modrinth / CurseForge.",
