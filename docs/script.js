...
const TRANSLATIONS = {
  de: {
    ...
    "features.peartree.desc": "Vollwertiges Bauset im warmen Schweizer Birnbaum-Design (Treppen, Stufen, Zäune, Tore, Glastüren, Falltüren, Platten, Knöpfe), optisch eigene Setzlinge und Birnen.",
    ...
    "install.step2.desc": "Lade die Datei <code class=\"code-badge\">mc-3ver-0.4.0.jar</code> von Modrinth, CurseForge oder GitHub herunter.",
  ...
  en: {
    ...
    "features.peartree.desc": "Full wood building set crafted in warm Swiss pear aesthetic (stairs, slabs, fences, gates, doors with glass panels, trapdoors, pressure plates, buttons), distinct saplings, and nourishing pears.",
    ...
    "install.step2.desc": "Download the <code class=\"code-badge\">mc-3ver-0.4.0.jar</code> file from Modrinth, CurseForge, or GitHub Releases.",
