...
* **Fabric Loader:** Updated to `0.19.5` (was `0.19.3`).
* **JUnit Jupiter:** Test framework updated to `5.12.2` (was `5.10.2`).
* Verified all mod classes, mixins, and unit tests with Java 25.
